...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        if ($full_name === '') {
            ...
            $r = $master_controller->updateProfile($master_id, $full_name, $phone, $email, $new_password);
            if (!($r['success'] ?? false)) {
            ...
            <form method="post" action="">
                ...
                <div class="row2">
                    <div class="field">
                        ...
                        <input id="full_name" name="full_name" type="text" required maxlength="150" value="<?php echo htmlspecialchars($master_user['full_name'] ?? ''); ?>">
                    </div>
                    <div class="field">
                        <label for="phone">Телефон</label>
                        <input id="phone" name="phone" type="text" required maxlength="30" value="<?php echo htmlspecialchars($master_user['phone'] ?? ''); ?>">
                    </div>
                </div>
                <div class="field">
                    <label for="email">Email</label>
                    <input id="email" name="email" type="email" required maxlength="150" value="<?php echo htmlspecialchars($master_user['email'] ?? ''); ?>">
                </div>
                <div class="row2">
                    <div class="field">
